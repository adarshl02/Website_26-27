          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4">
            <div className="text-neutral-300 text-lg opacity-70 py-6 md:col-span-1">
              <span className="block md:hidden">
                A grand 30-hour road painting event that brought together around
                800 enthusiastic participants, who competed to create stunning
                artworks on the Library Road, SGSITS, from February 3 to 4,
                2024. The event, organized by Club Pratibimb, not only
                celebrated creativity but also secured a place in the
                prestigious Official Book of Records in London.
              </span>
              <span className="hidden md:block">
                ...
                transforming the road into a vibrant, colorful masterpiece. With
                its jubilant atmosphere and record-breaking achievement,
                Streetscape was a truly unforgettable celebration of art and
                community spirit.
              </span>
            </div>
            ...
            <div className="md:col-span-2 mt-6 md:mt-0">
              <iframe
                ...
                src="https://www.youtube.com/embed/ucem4JGCIk0?rel=0&modestbranding=1&enablejsapi=1"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4">
            <div className="text-neutral-300 text-lg opacity-70 py-6 md:col-span-1">
              ...
              <span className="hidden md:block">
                ...
                urban art, concept art for social causes, and innovation and
                technology, transforming walls into vibrant expressions of
                creativity and purpose.Over the course of the marathon, teams
                and individuals worked tirelessly, transforming blank walls into
            ...
            <div className="md:col-span-2 mt-6 md:mt-0">
              <iframe
                className="w-full h-48 md:h-96 rounded-3xl"
                src="https://www.youtube.com/embed/oa-yFWUjEp0?rel=0&modestbranding=1&enablejsapi=1"
                title="YouTube video player"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4">
            <div className="text-neutral-300 text-lg opacity-70 py-6 md:col-span-1">
              <span className="block md:hidden">
                Graffathon 2.0 was an electrifying 48-hour artistic event held
                on the SGSITS campus on February 2nd and 3rd, 2019. Around 600
              ...
              <span className="hidden md:block">
                ...
                impression on the campus and everyone who witnessed it.{" "}
              </span>
            </div>
            <div className="md:col-span-1 flex justify-center">
              <img
            ...
            <div className="md:col-span-2 mt-6 md:mt-0">
              <iframe
                className="w-full h-48 md:h-96 rounded-3xl"
                src="https://www.youtube.com/embed/Z3XTYr_6yec?rel=0&modestbranding=1&enablejsapi=1"
                title="YouTube video player"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4">
            <div className="text-neutral-300 text-lg opacity-70 py-6 md:col-span-1">
              <span className="block md:hidden">
                ...
                Records . Artists came together to cover 63 wall stretches
                across a massive 4,800 square feet. The event, which lasted 36
                hours, from 10:00 AM on October 1 to 10:00 PM on October 2, was
                a testament to the students' dedication and artistic prowess.{" "}
              </span>
              <span className="hidden md:block">
                Club Pratibimb once again set a new record in the India Book of
                Records . Artists came together to cover 63 wall stretches
                ...
                hours, from 10:00 AM on October 1 to 10:00 PM on October 2, was
                a testament to the students' dedication and artistic prowess.
                The walls became canvases for a diverse array of themes, ranging
                from bold social commentary, urban art and many innovative
                themes .{" "}
              </span>
            </div>
            <div className="md:col-span-1 flex justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4">
            <div className="text-neutral-300 text-lg opacity-70 py-6 md:col-span-1">
              <span className="block md:hidden">
                ...
                prestigious spot in the Limca Book of Records for an
                extraordinary painting marathon. Over a grueling 36-hour
                stretch, beginning at 7:00 AM on September 22 and concluding at
                7:00 PM on September 23, 2012, 175 dedicated students
                transformed 24 campus walls into vibrant works of art.{" "}
              </span>
              <span className="hidden md:block">
                Club Pratibimb made history during Graffiti 2012, securing a
                prestigious spot in the Limca Book of Records for an
                ...
                stretch, beginning at 7:00 AM on September 22 and concluding at
                7:00 PM on September 23, 2012, 175 dedicated students
                transformed 24 campus walls into vibrant works of art. Covering
                a massive 2,400 square feet.The students collaborated to create
                themes that reflected social issues, environmental awareness,
